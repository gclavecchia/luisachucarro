...
const translations = {
  es: {
    ...
    contact: {
      ...
      sending: "Enviando...",
      success: "Gracias por su consulta. Nos pondremos en contacto pronto.",
  ...
  en: {
    ...
    contact: {
      ...
      send: "Send Inquiry",
      sending: "Sending...",
      success: "Thank you for your inquiry. We'll be in touch soon.",
...
export default function LuisAchucarro() {
  ...
  const [formData, setFormData] = useState({ name: "", email: "", phone: "", event: "", guests: "", date: "", message: "" });
        ...
        <div className="contact-grid" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "80px", maxWidth: "1100px" }}>
          <div>
            ...
            <div className={`fade-up stagger-2 ${isVisible("contact") ? "visible" : ""}`}>
              ...
              <a className="whatsapp-btn" href="https://wa.me/5491124508121?text=Hola%20Luis%2C%20me%20interesa%20consultar%20por%20sus%20servicios%20de%20chef." target="_blank" rel="noopener noreferrer">
          ...
          <div className={`fade-up stagger-1 ${isVisible("contact") ? "visible" : ""}`}>
            {sent ? (
              <div style={{
                ...
                <span style={{ fontFamily: "'Montserrat', sans-serif", fontSize: "11px", letterSpacing: "1.5px", color: "#C9A96E" }}>✓</span>
              </div>
            ) : (
              <form
              ...
              >
                ...
                >
                  <option value="" disabled style={{ color: "#6A6460" }}>{t.contact.event}</option>
                ...
                />
                {formError && (
                  <p style={{ fontFamily: "'Montserrat', sans-serif", fontSize: "12px", color: "rgba(201,169,110,0.7)" }}>
                    {t.contact.error}
                  </p>
                )}
                <button
                  ...
                  type="submit"
                  disabled={sending}
                  style={{ alignSelf: "flex-start", marginTop: "8px", opacity: sending ? 0.7 : 1, cursor: sending ? "not-allowed" : "pointer" }}
                >
      ...
      <footer style={{
        ...
        <div className="footer-grid" style={{ display: "grid", gridTemplateColumns: "1fr auto 1fr", gap: "40px", alignItems: "center", maxWidth: "1100px" }}>
          ...
          <div style={{ textAlign: "center" }}>
            <a href="https://www.instagram.com/achu8759" target="_blank" rel="noopener noreferrer" style={{
              display: "inline-flex",
              alignItems: "center",
              gap: "8px",
              color: "#7A7470",
